...
public class HomeAutomationSystem extends ViewableDigraph {
    ...
    public void layoutForSimView()
    {
        ...
        ((ViewableComponent)withName("PV")).setPreferredLocation(new Point(-70, 104));
        ((ViewableComponent)withName("Generator")).setPreferredLocation(new Point(0, 202));
        ((ViewableComponent)withName("Battery")).setPreferredLocation(new Point(403, 41));
        ((ViewableComponent)withName("House")).setPreferredLocation(new Point(332, 119));
        ((ViewableComponent)withName("LU")).setPreferredLocation(new Point(222, 207));
        ((ViewableComponent)withName("Tesla Model s")).setPreferredLocation(new Point(474, 243));
        ((ViewableComponent)withName("External Grid")).setPreferredLocation(new Point(158, 138));
        ((ViewableComponent)withName("Trancducer")).setPreferredLocation(new Point(50, 50));
    }
}
